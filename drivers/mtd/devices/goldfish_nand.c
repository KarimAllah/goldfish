...
err_no_working_dev:
printk("lllllllllllllllllllllllllllllllllllll err_no_working_dev\n");
	kfree(nand);
err_nand_alloc_failed:
printk("lllllllllllllllllllllllllllllllllllll err_nand_alloc_failed\n");
err_no_dev:
	iounmap(base);
printk("lllllllllllllllllllllllllllllllllllll err_no_dev\n");
err_ioremap:
err_no_io_base:
printk("lllllllllllllllllllllllllllllllllllll err_ioremap\n");
	return err;
}
